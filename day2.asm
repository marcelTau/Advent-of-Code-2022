...
; 
; rock:
;     cmp r10b, 66 ; paper = loss
;     je loss
; 
;     cmp r10b, 65 ; rock = draw
;     je draw
; 
;     cmp r10b, 67 ; scissors = win
;     je win
; 
; paper:
;     cmp r10b, 66 ; paper = draw
;     je draw
; 
;     cmp r10b, 65 ; rock = win
;     je win
; 
;     cmp r10b, 67 ; scissors = loss
;     je loss
; 
; scissors:
;     cmp r10b, 66 ; paper = win
;     je win
; 
;     cmp r10b, 65 ; rock = loss
;     je loss
; 
;     cmp r10b, 67 ; scissors = draw
;     je draw
; win:
;     add r8, 6
;     jmp loop
